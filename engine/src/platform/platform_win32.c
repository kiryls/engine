...
b8 platform_startup(
    ...
    state->h_instance = GetModuleHandleA(0);  // "give me the handle for the application that's currently executing this code"
    ...
    // Show the window
    b32 should_activate = 1;  // #todo if the window isn't accepting input, this should be false
